...
**FallOptom · sovereign single-file US optometry practice OS** — sovereign SDK extracted from `falloptom-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/falloptom-us-sdk
```

## Use
```js
import * as falloptom-us from '@ai-native-solutions/falloptom-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/falloptom-us-sdk/
- MCP wrapper: [`@ai-native-solutions/falloptom-us-mcp`](https://github.com/sjgant80-hub/falloptom-us-mcp)
- HTTP API: [`@ai-native-solutions/falloptom-us-api`](https://github.com/sjgant80-hub/falloptom-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/falloptom-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falloptom-us-sdk -- npx -y @ai-native-solutions/falloptom-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falloptom-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/falloptom-us-sdk/
- **Source**: https://github.com/sjgant80-hub/falloptom-us-sdk
